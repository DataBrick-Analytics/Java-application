...
import com.databrick.entity.TransportationSystem;
...
public class TransportationSystemService {
    ...
    public void extractionTransportationSystemData(List<InputStream> bucketObjects) {
        ...
        try {
            for (InputStream bucketObject : bucketObjects) {
                ...
                for (int i = 0; i < sheet.getPhysicalNumberOfRows(); i++) {
                    ...
                    TransportationSystem transportationSystem = new TransportationSystem(cellValues.get(1), cellValues.get(2), cellValues.get(3), cellValues.get(4), cellValues.get(5));

                    Boolean wasSaved = jdbcService.saveTransportationSystem(transportationSystem);
